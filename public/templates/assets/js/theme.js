    ...
    jQuery(document).ready(function () {
        ...
        function formatState(state) {
            ...
            $state
                ...
                .attr(
                    "src",
                    baseUrl + "/" + state.element.value.toLowerCase() + ".jpg"
                );
        ...
        function emailto(state) {
            ...
            var $state = $('<span><img class="avatar" /> <span></span></span>');
            // Use .text() instead of HTML string concatenation to avoid script injection issues
            $state.find("span").text(state.text);
            $state
                .find("img")
        ...
        if ($(".kleon-vertical-nav .kleon-navmenu .main-menu").length) {
            dynamicCurrentMenuClass(
                $(".kleon-vertical-nav .kleon-navmenu .main-menu")
            );
        }
        ...
        $(
            ".kleon-navmenu ul.main-menu li.menu-item-has-children > a, .kleon-navmenu ul.main-menu li.menu-item-has-children .submenu-opener"
        ).on("click", function (e) {
        ...
        allNextBtn.click(function () {
            var curStep = $(this).closest(".custom-form-wizard-block"),
                ...
                nextStepWizard = $(
                    '.custom-form-wizard-block-tab a[href="#' +
                        curStepBtn +
                        '"]'
                )
                    .parent()
        ...
        $("input[name=checkLayout]:radio").on("click", function (e) {
            if (e.currentTarget.value == "vertical") {
                ...
                $("body").removeClass(
                    "layout-horizontal-nav layout-combo-nav kleon-vertical-nav--collapse"
                );
            } else if (e.currentTarget.value == "horizontal") {
                $("body").addClass("layout-horizontal-nav");
                $("body").removeClass(
                    "layout-vertical-nav layout-combo-nav kleon-vertical-nav--collapse"
                );
            } else if (e.currentTarget.value == "combo") {
                $("body").addClass(
                    "layout-combo-nav kleon-vertical-nav--collapse"
                );
                $("body").removeClass(
                    "layout-vertical-nav layout-horizontal-nav"
                );
            }
        });
