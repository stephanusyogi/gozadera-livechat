    ...
    <div class="container-fluid">
        <div class="inner-contents">
            <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                <div class="left-part">
                    <h2 class="text-dark">Add New Table</h2>
                </div>
            ...
            <div class="card border-0">
                <div class="card-body pt-3">
                    <form id="addAdminForm" action="{{ route('all-table.add-action') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @if ($errors->has('code')) is-invalid text-danger @elseif(old('code') && !$errors->has('code')) is-valid text-success @endif" id="code" value="{{ old('code') }}" name="code" placeholder="Table Code">
                                    @error('code')
